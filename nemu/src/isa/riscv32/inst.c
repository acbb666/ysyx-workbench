...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, { int64_t  res = (int64_t)(sword_t)src1 * (int64_t)(sword_t)src2; R(rd) = (word_t)(res >> 32); });
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu, R,{ int64_t  res = (int64_t)(sword_t)src1 * (uint64_t)src2; R(rd) = (word_t)(res >> 32); });
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu, R, { uint64_t res = (uint64_t)src1 * (uint64_t)src2; R(rd) = (word_t)(res >> 32); });
  ...
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem , R, R(rd) = (sword_t)src2 == 0 ? (sword_t)src1 : (sword_t)src1 % (sword_t)src2);
